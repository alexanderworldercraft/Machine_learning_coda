...
def load_image_features(pet_id, image_dir, model, transform):
...
# Création du modèle avec validation croisée et recherche d'hyperparamètres pour GradientBoostingClassifier
print("Recherche des meilleurs hyperparamètres avec GridSearchCV pour GradientBoostingClassifier...")
...
submission_path = './asset/data/submission_image_GradientBoostingClassifier_pytorch.csv'
